...
let howmanytimecanguess=5;
        ...
        btnans.addEventListener("click",()=>{
            ...
            howmany=howmany+1
            if (howmany<howmanytimecanguess) {
                guess()
            } else {
                alert('以達'+howmanytimecanguess+"次")
            ...
            function guess() {
                ...
                if ( inputvalue <x) {
                    inputxt.min = x;
                    inputxt.value=x;
                    alert('不能低於'+x+','+'剩餘'+(howmanytimecanguess-howmany)+"次")
                    a=false
                }
                if ( inputvalue >y) {
                    inputxt.max = y;
                    inputxt.value=y;
                    alert('不能高於'+y+','+'剩餘'+(howmanytimecanguess-howmany)+"次")
                    b=false
                }
                ...
                if ( inputvalue === z) {
                    ...
                    alert('太小'+','+'剩餘'+(howmanytimecanguess-howmany)+"次");
                    x=parseInt(inputvalue);
                }else if(inputvalue > z && a===true && b===true) {
                    alert('太大'+','+'剩餘'+(howmanytimecanguess-howmany)+"次");
        ...
        rebtn.addEventListener("click",()=>{
            ...
            howmany =0
            console.log("已猜"+howmany+"次")
            alert('剩餘'+(howmanytimecanguess-howmany)+"次")
